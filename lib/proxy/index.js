 ...
 * @param {Boolean} is_reverse_proxy -
 * @returns {Object[]} middleware_list - Array of anonymous objects with `Object.value` containing an object evaluated
 * using the passed in parameters. `Object.(forward|reverse)_proxy === true` iff the middleware should be used for a forward or reverse
 * proxy, respectively. Order matters!
 */
