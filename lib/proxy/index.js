  ...
  var middleware_list = [
    {
      ...
      name: 'form_parser_pre_mutator',
      desc: '',
      forward_proxy: true,
      reverse_proxy: true,
      value: require('./mutators/stash_original_content_type.js')
    }, {
      name: 'form_parser',
      ...
      name: 'form_parser_post_mutator',
      desc: '',
      forward_proxy: true,
      reverse_proxy: true,
      value: require('./mutators/restore_original_content_type.js')
    }, {
