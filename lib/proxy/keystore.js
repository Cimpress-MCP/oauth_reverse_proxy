...
function ProxyKeystore(config) {
  ...
  Object.defineProperty(this, "quota", { value: new ProxyQuotas(config) });
    ...
    list.forEach(function(file_name) {
      try {
        ...
        if (stat.isFile()) {
          ...
          Object.defineProperty(this_obj.keys, file_name, { value: encoding.encodeData(file_contents), configurable: true, enumerable: true });
